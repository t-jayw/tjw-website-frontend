    ...
    <h2>Projects</h2>
      ...
      <article className="project">
        ...
        <div className="content">
          ...
          <p>A pop punk cover of Elliott Smith's "Angeles" — one of my favorite songs. Everything recorded by me. Except the drums are computer.</p>
      ...
      <Project 
        title="ChronoLog" 
        description="iOS and Android app written in Flutter to help watch collectors track accuracy of watches. 30k+ downloads. 1200+ premium purchases. 4.7 stars/200+ reviews on iOS." 
        imageUrl={watchlogo}
        link="/chronolog"
      />
